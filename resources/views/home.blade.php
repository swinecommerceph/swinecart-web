    ...
    <div class="container">
      <div class="col s6" style="margin: 3rem 0 2rem 0; border-right: thick solid #fff;">
        <div class="col s12 white-text">
          ...
          <div class="col s12" style="">
            {{-- <p class="left-align"> --}}
            <a href="#!" class="btn-flat white-text"><i class="material-icons right">chevron_right</i> Get accredited
            </a> <br>
            <a href="{{ url('login') }}" class="btn-flat white-text"><i class="material-icons right">chevron_right</i>
              Log-in </a> <br>
      ...
      <div class="col s6" style="margin: 3rem 0 2rem 0;">
        <div class="col s12 white-text">
          ...
          <div class="col s12" style="">
            {{-- <p class="left-align"> --}}
            <a href="{{ url('register') }}" class="btn-flat white-text"><i
                class="material-icons right">chevron_right</i> Register </a> <br>
            <a href="{{ url('login') }}" class="btn-flat white-text"><i class="material-icons right">chevron_right</i>
              Log-in </a> <br>
  ...
  <div class="row">
    ...
    <div class="row">
      ...
      <div class="col s12 m6 right-align">
        <p>
          <span>
            <a href="{{ route('termsOfAgreement') }}" target="_blank">
              Terms
            </a>
          </span>

          <span class="external-home-links">
            <a href="{{ route('customerPrivacyPolicy') }}" target="_blank">
              Customer Policy
            </a>
          </span>

          <span class="external-home-links">
            <a href="{{ route('breederPrivacyPolicy') }}" target="_blank">
              Breeder Policy
            </a>
          </span>
