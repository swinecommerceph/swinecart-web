...
<div class="row">
  ...
  <div class="col s12">
    {!! Form::model($breeder,['route' => 'breeder.updatePersonal', 'method' => 'PUT', 'data-personal-id' =>
    $breeder->id]) !!}
    <div id="personal-information" class="card-panel">
      ...
      <div class="row">
        <div class="col s10 offset-s1 content-section">
          <div class="col right">
            <button id="" class="btn btn-medium waves-effect waves-light primary primary-hover tooltipped edit-button"
              data-position="left" data-delay="50" data-tooltip="Edit Office Information">
              Edit
            </button>
          </div>
          <div class="col right">
            <a href="#!" id=""
              class="btn btn-medium waves-effect waves-light secondary secondary-hover tooltipped cancel-button"
      ...
      <div class="row">
        ...
        <div class="input-field col s10 push-s1">
          {!! Form::text('officeAddress_addressLine1', null, ['disabled' => 'disabled', 'id' =>
      ...
      <div class="row">
        ...
        <div class="input-field col s10 push-s1">
          {!! Form::text('officeAddress_addressLine2', null, ['disabled' => 'disabled', 'id' =>
      ...
      <div class="row">
        <!-- Address: Province -->
        <div id="office-province" class="input-field col s5 push-s1">
          {!! Form::select('officeAddress_province', $provinces, null, ['disabled' => 'disabled', 'id' =>
          'office_provinces']); !!}
        ...
        <div class="row add-farm">
          <div class="col s10 offset-s1">
            ...
            <div id="{{ $farmAddress->name }}" class="card-panel hoverable">
              ...
              {!! Form::open(['route' => 'breeder.updateFarm', 'method' => 'PUT', 'class' => 'edit-farm', 'data-farm-id'
              => $farmAddress->id, 'data-farm-order' => $loop->iteration]) !!}

              <div class="row">
                <div class="col s10 offset-s1 content-section">
                  <div class="col right">
                    <button class="btn btn-medium waves-effect waves-light primary primary-hover tooltipped edit-button"
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="right-align" style="padding:0;">
                          {{ date_format(date_create($farmAddress->accreditation_date), 'F Y') }} </td>
                      </tr>
                      <tr>
                        <td class="" style="padding:0;"> Expiry Date </td>
                        <td class="right-align" style="padding:0;">
                          {{ date_format(date_create($farmAddress->accreditation_expiry), 'F Y') }} </td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div class="row">
                ...
                <div>
                  ...
                  <label for="check" class="teal-text text-darken-4"><b>Address is same as Office
                      Information</b></label>
                </div>
                <br>
              ...
              <div class="row">
                <!-- Farm Address: Province -->
                <div id="farm-province" class="input-field col s5 push-s1" id="farm-{{ $farmNumber }}">
...
<div id="password-information" class="card-panel">
  ...
  <div class="row">
    <div class="input-field col s4 offset-s4">
      <input type="password" id="newpasswordconfirm" name="new_password_confirmation" class="validate login-password"
        required>
  ...
  <div class="row">
    <div class="col s4 offset-s4">
      <a href="#" style="width: 17vw;" id="change-password-button"
        class="btn teal darken-3 btn-medium waves-effect waves-light">
        Change Password
      </a>
    </div>
  </div>
