...
<div class="row">
	...
	<div class="col s12">
		{!! Form::model($breeder,['route' => 'breeder.updatePersonal', 'method' => 'PUT', 'personal-id' => $breeder->id]) !!}
					...
					<div class="row add-farm">
						<div class="col s10 offset-s1">
							<div id="{{ $farmAddress->name }}" class="card-panel hoverable">
								{!! Form::open(['route' => 'breeder.updateFarm', 'method' => 'PUT', 'class' => 'edit-farm', 'farm-id' => $farmAddress->id]) !!}
								...
								{!! Form::open(['route' => 'breeder.deleteFarm', 'method' => 'DELETE', 'class' => 'delete-farm', 'farm-id' => $farmAddress->id]) !!}
									<div class="row ">
