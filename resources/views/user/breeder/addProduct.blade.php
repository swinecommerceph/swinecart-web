...
<div id="add-product-modal" class="row">
  ...
  <div class="col s11">
        ...
        <div class="row">
          <div class="col s4.5" style="padding-left: 0px !important">
            <div id="select-type-wrapper" style="margin-bottom: 2vh; width: 10vw;" class="input-field">
              ...
              <label id="select-type-label" for="type" style="font-size: 1rem; margin-top: 2rem;"
                class="teal-text text-darken-4">Type</label>
            </div>
          </div>
    ...
    <blockquote id="semen-blockquote" class="info-two" style="display: none !important;">
    ...
    <div class="s6 col">
      <span class="col s2 center-align" style="padding:0; margin-left: 1rem; margin-right: 0.5rem;">
        <span class="col s12" style="padding:0;">
          <input type="number" ref="input" value="1" min="1" class="product-quantity center-align" style="margin:0;">
        </span>
      </span>
    </div>
    ...
    <div class="row">
      ...
      <div class="col s6">
        ...
        <div class="row">
          ...
          <div class="input-crossbreed-container">
            ...
            <div class="input-field" style="width: 20vw;">
              ...
              {!! Form::label('fbreed', 'Father\'s Breed', ['class' => 'teal-text text-darken-4', 'style' => 'font-size:
              1rem;']) !!}
            </div>
            <div class="input-field" style="width: 20vw;">
              {!! Form::text('mbreed', null, ['id' => 'mbreed', 'class' => 'validate input-manage-products'])!!}
              {!! Form::label('mbreed', 'Mother\'s Breed', ['class' => 'teal-text text-darken-4', 'style' => 'font-size:
              1rem;']) !!}
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col s5.5" style="padding-left: 0px !important">
            <div class="input-field" style="width: 13vw; display: flex !important;">
              ...
              <i class="birthdate-icon material-icons teal-text text-darken-2">
                date_range
              </i>
        ...
        <div class="input-field">
          {!! Form::text('birthweight', null, ['class' => 'validate input-manage-products', 'style' => 'width:
          7vw;'])!!}
          {!! Html::decode(Form::label('birth_weight','<p style="font-size:1rem;" class="teal-text text-darken-4">Birth
            weight <span class="grey-text"><i>- Optional</i></span></p>')) !!}
        </div>
        ...
        <div class="input-field">
          ...
          {!! Html::decode(Form::label('adg','<p style="font-size:1rem;" class="teal-text text-darken-4">Average Daily
            Gain (grams) <span class="grey-text"><i>- Optional</i></span></p>')) !!}
        </div>
        ...
        <div class="row">
          ...
          <div class="input-field">
            ...
            {!! Html::decode(Form::label('fcr','<p style="font-size:1rem;" class="teal-text text-darken-4">Feed
              Conversion Ratio <span class="grey-text"><i>- Optional</i></span></p>')) !!}
          </div>

          {{-- Backfat thickness --}}
          <div class="input-field">
            {!! Form::text('backfat_thickness', null, ['class' => 'validate input-manage-products', 'style' => 'width:
            7vw;'])!!}
            {!! Html::decode(Form::label('backfat_thickness','<p style="font-size:1rem;"
          ...
          <div class="input-field">
            ...
            {!! Html::decode(Form::label('lsba','<p style="font-size:1rem;" class="teal-text text-darken-4">Litter size
              born alive <span class="grey-text"><i>- Optional</i></span></p>')) !!}
          </div>
        </div>
        ...
        <div id="number-of-teats-container" style="display: none;">
          ...
          <div class="col s4 input-field" style="padding-left: 0vw !important; margin-top: 0vh !important;">
            {!! Form::text('left_teats', null, ['class' => 'validate input-manage-products', 'style' => 'width:
            4vw;'])!!}
            {!! Form::label('left_teats', '(left)', ['class' => 'teal-text text-darken-4', 'style' => 'font-size: 1rem;
            padding-left: 0vw;']) !!}
          </div>

          {{-- Number of teats (right) --}}
          <div class="col s4 input-field" style="margin-top: 0vh !important;">
            {!! Form::text('right_teats', null, ['class' => 'validate input-manage-products', 'style' => 'width:
            4vw;'])!!}
            {!! Form::label('right_teats', '(right)', ['class' => 'teal-text text-darken-4', 'style' => 'font-size:
            1rem;']) !!}
          </div>
        </div>
    ...
    {{-- Add Product button --}}
    <div>
      <button style="font-weight: 900; width: 15vw; font-size: 1.4rem" id="submit-button" type="submit"
        class="right btn-large waves-effect waves-light teal darken-4"> Add Product</button>
    </div>
    {!! Form::close() !!}
  </div>
</div>
...
<div id="add-media-modal" class="modal modal-fixed-footer">
  <div class="modal-content">
    <h4>Add Media</h4>
    <div class="row">
      {!! Form::open(['route' => 'products.mediaUpload', 'class' => 's12 dropzone', 'id' => 'media-dropzone', 'enctype'
      => 'multipart/form-data']) !!}
      <div class="fallback">
    ...
    <blockquote class="info-two">
      <b>Note:</b> Adding media (images or videos) is not required in Adding a Product. You can add them later when
      editing a product.
    </blockquote>
  </div>
  <div class="modal-footer">
    <button id="next-button" type="submit" class="btn waves-effect waves-light modal-action teal darken-3"> Product
      Summary </button>
  </div>
</div>
