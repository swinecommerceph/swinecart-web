    ...
    <div class="row">
      <div class="card">
        <div class="card-image">
          <img style="width: 39vw; height: 50vh;" src="{{$product->img_path}}"
      ...
      <li class="collection-header">
        <h4 class="row">
          ...
          <div class="col right">
            ...
            !!}
            <a href="#" class="btn primary primary-hover right tooltipped add-to-cart" data-position="left"
        ...
        <div class="row">
          <div class="col">
            Breeder:
            <a class="blue-text" style="font-weight: 700;"
              href="{{ route('viewBProfile', ['breeder' => $product->breeder_id]) }}">
              {{ $product->breeder }}
            </a><br>
  ...
  <div class="col s7">
    <ul>
      <li id="stars-container" class="collection-item grey lighten-4">
        ...
        <a href="/customer/messages/{{ $product->userid }}" class="right tooltipped" data-position="left"
          data-delay="50" data-tooltip="Send Message to Breeder">
