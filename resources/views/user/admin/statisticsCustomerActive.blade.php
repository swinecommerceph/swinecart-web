...
@section('pageId')
    id="admin-site-statistics-active-statistics-customer"
@endsection
        ...
        <div class="col s12 m12 l12 xl12">
            <div class="valign-wrapper row">
                <div class="input-field col s12 m12 l6 xl6 valign">
                        <select onChange="window.location.href=this.value">
                            <option disabled selected>Choose option</option>
                            <option selected value="{{route('admin.statistics.customer.active')}}">Registered Customers</option>
                ...
                <div class="col s12 m12 l6 xl6 valign">
                    {!!Form::open(['route'=>'admin.statistics.customer.active-year', 'method'=>'GET', 'class'=>'valign-wrapper'])!!}
