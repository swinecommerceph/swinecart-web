...
@section('pageId')
    id="admin-site-statistics-deleted-statistics-customer"
@endsection
            ...
            <div class="valign-wrapper row">
                <div class="input-field col s12 m12 l6 xl6 valign">
                        <select onChange="window.location.href=this.value">
                            ...
                            <option selected value="{{route('admin.statistics.customer.deleted')}}">Deleted Customers</option>
                ...
                <div class="col s12 m12 l6 xl6 valign">
                    {!!Form::open(['route'=>'admin.statistics.customer.deleted-year', 'method'=>'GET', 'class'=>'valign-wrapper'])!!}
