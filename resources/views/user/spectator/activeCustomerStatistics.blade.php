            ...
            <div class="col s12 m12 l12 xl12">
                <div class="valign-wrapper row">
                    <div class="input-field col s12 m12 l6 xl6">
                        <select onChange="window.location.href=this.value">
                            <option selected value="{{route('spectator.statisticsActiveCustomer')}}">Active Customers</option>
                            <option value="{{route('spectator.statisticsBlockedCustomer')}}">Blocked Customers</option>
                            <option value="{{route('spectator.statisticsDeletedCustomer')}}">Deleted Customers</option>
                        </select>
                        <label>Chart</label>
                    </div>
                    <div class="col s12 m12 l6 xl6">
                        {!!Form::open(['route'=>'spectator.statisticsActiveCustomerYear', 'method'=>'GET', 'class'=>'row valign-wrapper'])!!}
                    ...
                    {{-- <div class="col s6">
                        {!!Form::open(['route'=>'spectator.statisticsActiveCustomerYear', 'method'=>'GET'])!!}
                        <label for="stats-year">Year</label>
                        <input id="stats-year" type="number" name="year" min="{{ $yearMinMax[0] }}" max="{{ $yearMinMax[1] }}" value="{{ $year }}">
                        <div class="center">
                            <button class="btn waves-effect waves-light" type="submit" name="year-submit">Show</button>
