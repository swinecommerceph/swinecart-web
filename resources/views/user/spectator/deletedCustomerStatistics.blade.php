                ...
                <div class="valign-wrapper row">
                    <div class="input-field col s12 m12 l6 xl6">
                        <select onChange="window.location.href=this.value">
                            ...
                            <option selected value="{{route('spectator.statisticsDeletedCustomer')}}">Deleted Customers</option>
                    ...
                    <div class="col s12 m12 l6 xl6">
                        {!!Form::open(['route'=>'spectator.statisticsDeletedCustomerYear', 'method'=>'GET', 'class'=>'row valign-wrapper'])!!}
