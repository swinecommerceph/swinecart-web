        ...
        <div class="col s12">
            <div class="valign-wrapper row">
                <div class="input-field col s12 m12 l6 xl6">
                    <select onChange="window.location.href=this.value">
                        <option selected value="{{route('spectator.statisticsActiveBreeder')}}">Active Breeders</option>
                        ...
                        <option {{$select[0]}} value="{{route('spectator.averageBreederStatisticsCreated')}}">Average Monthly Breeders Created</option>
                        <option {{$select[1]}} value="{{route('spectator.averageBreederStatisticsBlocked')}}">Average Monthly Breeders Blocked</option>
                        <option {{$select[2]}} value="{{route('spectator.averageBreederStatisticsDeleted')}}">Average Monthly Breeders Deleted</option>
                    </select>
                    <label>Chart</label>
                </div>
