    ...
    <nav class="primary">
      <div class="nav-wrapper navbar-container">
        ...
        <ul id="nav-mobile" class="right hide-on-med-and-down">
          ...
          <li><a target="_blank"
              href="https://www.bai.gov.ph/index.php/regulatory/item/356-accreditation-of-swine-breeder-farm?fbclid=IwAR2a7y6XuslFq7ufqiX588lhJ73oQDjtduYNY8ndH69gxhf9JfDXJ994aEQ">
              SBFAP </a></li>
          @if(Request::is('/'))
