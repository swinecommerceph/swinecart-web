          ...
          <div class="row ">
              <div class="menu-wrapper col s3">
                  <div id="menu">
                    ...
                    <li>
                     <a href="{{route('admin.statistics.created.default')}}" class="black-text" id='statistics'> <div class="collapsible-header"><i class="material-icons">trending_up</i>Site Statistics</div></a>
                    </li>
                    <li>
