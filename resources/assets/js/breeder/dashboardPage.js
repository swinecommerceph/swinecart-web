...
var vm = new Vue({
  ...
  computed: {
    requestedProductsBoar: function() {
      return this.turnUndefinedToZero(this.dashboardStats.requested.boar);
    },
    requestedProductsSow: function() {
      return this.turnUndefinedToZero(this.dashboardStats.requested.sow);
    },
    requestedProductsGilt: function() {
      return this.turnUndefinedToZero(this.dashboardStats.requested.gilt);
    },
    requestedProductsSemen: function() {
      return this.turnUndefinedToZero(this.dashboardStats.requested.semen);
    },
    reservedProductsBoar: function() {
      return this.turnUndefinedToZero(this.dashboardStats.reserved.boar);
    },
    reservedProductsSow: function() {
      return this.turnUndefinedToZero(this.dashboardStats.reserved.sow);
    },
    reservedProductsGilt: function() {
      return this.turnUndefinedToZero(this.dashboardStats.reserved.gilt);
    },
    reservedProductsSemen: function() {
      return this.turnUndefinedToZero(this.dashboardStats.reserved.semen);
    },
    onDeliveryProductsBoar: function() {
      return this.turnUndefinedToZero(this.dashboardStats.on_delivery.boar);
    },
    onDeliveryProductsSow: function() {
      return this.turnUndefinedToZero(this.dashboardStats.on_delivery.sow);
    },
    onDeliveryProductsGilt: function() {
      return this.turnUndefinedToZero(this.dashboardStats.on_delivery.gilt);
    },
    onDeliveryProductsSemen: function() {
      return this.turnUndefinedToZero(this.dashboardStats.on_delivery.semen);
    },
    hiddenProductsBoar: function() {
      return this.turnUndefinedToZero(this.dashboardStats.hidden.boar);
    },
    hiddenProductsSow: function() {
      return this.turnUndefinedToZero(this.dashboardStats.hidden.sow);
    },
    hiddenProductsGilt: function() {
      return this.turnUndefinedToZero(this.dashboardStats.hidden.gilt);
    },
    hiddenProductsSemen: function() {
      return this.turnUndefinedToZero(this.dashboardStats.hidden.semen);
    },
    displayedProductsBoar: function() {
      return (
        this.turnUndefinedToZero(this.dashboardStats.displayed.boar) +
        this.turnUndefinedToZero(this.dashboardStats.requested.boar)
      );
    },
    displayedProductsSow: function() {
      return (
        this.turnUndefinedToZero(this.dashboardStats.displayed.sow) +
        this.turnUndefinedToZero(this.dashboardStats.requested.sow)
      );
    },
    displayedProductsGilt: function() {
      return (
        this.turnUndefinedToZero(this.dashboardStats.displayed.gilt) +
        this.turnUndefinedToZero(this.dashboardStats.requested.gilt)
      );
    },
    displayedProductsSemen: function() {
      return (
        this.turnUndefinedToZero(this.dashboardStats.displayed.semen) +
        this.turnUndefinedToZero(this.dashboardStats.requested.semen)
      );
    },
    availableProductsBoar: function() {
      return (
        this.turnUndefinedToZero(this.dashboardStats.requested.boar) +
        this.turnUndefinedToZero(this.dashboardStats.displayed.boar) +
        this.turnUndefinedToZero(this.dashboardStats.hidden.boar)
      );
    },
    availableProductsSow: function() {
      return (
        this.turnUndefinedToZero(this.dashboardStats.requested.sow) +
        this.turnUndefinedToZero(this.dashboardStats.displayed.sow) +
        this.turnUndefinedToZero(this.dashboardStats.hidden.sow)
      );
    },
    availableProductsGilt: function() {
      return (
        this.turnUndefinedToZero(this.dashboardStats.requested.gilt) +
        this.turnUndefinedToZero(this.dashboardStats.displayed.gilt) +
        this.turnUndefinedToZero(this.dashboardStats.hidden.gilt)
      );
    },
    availableProductsSemen: function() {
      return (
        this.turnUndefinedToZero(this.dashboardStats.requested.semen) +
        this.turnUndefinedToZero(this.dashboardStats.displayed.semen) +
        this.turnUndefinedToZero(this.dashboardStats.hidden.semen)
      );
    },
    overallOnDelivery: function() {
      var sum =
        this.turnUndefinedToZero(this.dashboardStats.on_delivery.boar) +
        this.turnUndefinedToZero(this.dashboardStats.on_delivery.gilt) +
        this.turnUndefinedToZero(this.dashboardStats.on_delivery.semen) +
        this.turnUndefinedToZero(this.dashboardStats.on_delivery.sow);
      return sum;
    },

    overallReserved: function() {
      var sum =
        this.turnUndefinedToZero(this.dashboardStats.reserved.boar) +
        this.turnUndefinedToZero(this.dashboardStats.reserved.gilt) +
        this.turnUndefinedToZero(this.dashboardStats.reserved.semen) +
        this.turnUndefinedToZero(this.dashboardStats.reserved.sow);
      return sum;
    },
    ...
    overallRatings: function() {
      var overallAvgRating =
        (this.dashboardStats.ratings.delivery +
          this.dashboardStats.ratings.transaction +
          this.dashboardStats.ratings.productQuality) /
        3;
      return this.round(overallAvgRating, 2);
    }
  },
  methods: {
    turnUndefinedToZero: function(value) {
    ...
    dateFromChange: function(value) {
      ...
      switch (this.chosenFrequency) {
        case "monthly":
          ...
          constrictedDate = plusElevenMonths.isSameOrAfter(now)
            ? now
            : plusElevenMonths;
    ...
    getPattern: function(shape, color) {
      ...
      return Chart.helpers.extend(bgPattern, {
        r: rgb.red(),
        g: rgb.green(),
        b: rgb.blue(),
        alpha: rgb.alpha()
    ...
    retrieveSoldProducts: function() {
      ...
      if (
        (this.dateFromObject.get() && this.dateToObject.get()) ||
        this.chosenFrequency === "weekly"
      ) {
        // Do AJAX
        this.$http
          .get(config.dashboard_url + "/sold-products", {
            params: {
        ...
        switch (data.type) {
          ...
          case "db-rated":
            var currentDeliveryRating = self.dashboardStats.ratings.delivery,
              currentTransactionRating =
                self.dashboardStats.ratings.transaction,
              currentProductQualityRating =
                self.dashboardStats.ratings.productQuality;

            // Compute new averages
            self.dashboardStats.ratings.delivery = self.computeAverageRating(
              currentDeliveryRating,
              data.rating_delivery
            );
            self.dashboardStats.ratings.transaction = self.computeAverageRating(
              currentTransactionRating,
              data.rating_transaction
            );
            self.dashboardStats.ratings.productQuality = self.computeAverageRating(
              currentProductQualityRating,
              data.rating_productQuality
            );

            // Update reviews
            if (self.dashboardStats.ratings.reviews.length >= 3)
